...
const MenuRegist = lazy(() => import('@/pages/app/MenuRegist'));

const Category = lazy(() => import('@/pages/app/Category'));

const CategoryRegist = lazy(() => import('@/pages/app/CategoryRegist'));

const Inventory = lazy(() => import('@/pages/app/Inventory'));

const InventoryRegist = lazy(() => import('@/pages/app/InventoryRegist'));

const InventoryDetail = lazy(() => import('@/pages/app/InventoryDetail'));

const InventoryDetailRegist = lazy(
  () => import('@/pages/app/InventoryDetailRegist')
);

const Order = lazy(() => import('@/pages/app/Order'));
...
const routes = [
  ...
  { path: '/category', title: 'Category', element: Category },
  {
    ...
    title: 'Category-regist',
    element: CategoryRegist,
  },
  { path: '/inventory', title: 'Inventory', element: Inventory },
  {
    path: '/inventory/regist',
    title: 'Inventory-regist',
    element: InventoryRegist,
  },
  {
    path: '/inventory/:id',
  ...
  {
    path: '/inventory/:id/regist',
    title: 'Inventory-detail-regist',
    element: InventoryDetailRegist,
  },
